   ...
   <div>
     <nav className="bg-white/90 backdrop-blur shadow-lg h-16">
       <div className="flex items-center justify-between max-w-7xl mx-auto px-6 h-full">
         <img 
           src="/OmenifyLogo.png" 
           alt="OMENIFY" 
           className="h-40 w-auto -mt-12 -mb-12 object-contain" // Made logo much bigger with adjusted margins
         />
     ...
     <main class="max-w-7xl mx-auto px-6 py-8">
       ...
       <div class="text-white mb-12 text-center">
         ...
         <p class="text-xl text-blue-400 font-mono">Track today to capture tomorrow.</p>
       </div>
